  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-subtle": {
          "0%, 100%": { boxShadow: "0 0 0 0 rgba(var(--primary-rgb), 0.4)", transform: "scale(1)" },
          "50%": { boxShadow: "0 0 0 8px rgba(var(--primary-rgb), 0)", transform: "scale(1.05)" },
        },
      },
      animation: {
      ...
      boxShadow: {
        ...
        "ig-card": "0 1px 2px rgba(0, 0, 0, 0.1)",
      },
    },
  },
